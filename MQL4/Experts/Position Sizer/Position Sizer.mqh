...
// Main
    ...
    if (!ButtonCreate(MainTabList, m_MoveAllSL, third_column_start, y, third_column_start + narrow_label_width, y + element_height, "m_MoveAllSL", "MoveAllSL"))                                        return false;  
...
void CPositionSizeCalculator::OnClickMoveAllOpenSL()
{
    MoveAllOpenSL();
}
